        ...
        <div className='testimonial-box'>
                ...
                <div className='user-testimonial-box'>
                    <div className='end'>
                        <div className='user-testimonial'>
                            <div className='text'><i>ST.TERESA has the best pharmacy service hands down!
            ...
            <div className='rightside'>
                <div className='details-box'>
                    ...
                    <h1>At ST.TERESA <br />Pharmacy, <br />Patients Matter</h1>
                    <p>Find out what they are saying about ST.TERESA.</p>
                </div>
            </div>
        </div>
    )
