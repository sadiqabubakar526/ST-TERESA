...
export const SimpleJoinForm = () => {
    return (
        <motion.div className='form-div'
            ...
            initial="hidden"
            animate="visible">
            <motion.h1 variants={childVariants}>Join St.teresa Pharmacy</motion.h1>
            <motion.p variants={childVariants}>You can join st.teresa pharmacy as Doctor, Patient and Vendor</motion.p>
            <br />
            <motion.div className='form' variants={childVariants}>
                <form autoComplete="off" className='st.teresa-form'>
